...
public class EncryptUtil {
    ...
    private String messageDigest(String res, String algorithm) {
        return this.messageDigest(res, algorithm, null);
    }

    private String messageDigest(String res, String algorithm, Boolean base64Convert) {
        try {
            base64Convert = base64Convert == null ? false : base64Convert;
    ...
    private String base64(byte[] res) {
        return String.valueOf(Base64.encode(res, Base64.DEFAULT));
    }
