...
public class VideoRecorder implements OnInfoListener, CapturePreviewInterface {
    ...
    public void switchCamera(){
        if(mCameraWrapper!=null){
            ...
            if(mCameraWrapper.getCameraId()== Camera.CameraInfo.CAMERA_FACING_BACK){
                if(mRecorder!=null)
                   mRecorder.setOrientationHint(90);
            }else if(mCameraWrapper.getCameraId()== Camera.CameraInfo.CAMERA_FACING_FRONT){
                if(mRecorder!=null)
    ...
    protected void configureMediaRecorder(final MediaRecorder recorder, android.hardware.Camera camera) throws IllegalStateException, IllegalArgumentException {
        ...
        //RecordingSize size=new RecordingSize(mCaptureConfiguration.getVideoWidth(),mCaptureConfiguration.getVideoHeight());
